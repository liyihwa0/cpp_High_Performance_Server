...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_raft_5fcore_5fproto_2eproto 
...
class LogEntry : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.raft.LogEntry) */ {
 public:
  LogEntry();
  virtual ~LogEntry();
 ...
 private:
  ...
  friend struct ::protobuf_raft_5fcore_5fproto_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class AppendEntriesArgs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.raft.AppendEntriesArgs) */ {
 public:
  AppendEntriesArgs();
...
class AppendEntriesReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.raft.AppendEntriesReply) */ {
 public:
  AppendEntriesReply();
...
class RequestVoteArgs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.raft.RequestVoteArgs) */ {
 public:
  RequestVoteArgs();
...
class RequestVoteReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.raft.RequestVoteReply) */ {
 public:
  RequestVoteReply();
...
class InstallSnapshotRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.raft.InstallSnapshotRequest) */ {
 public:
...
class InstallSnapshotResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.raft.InstallSnapshotResponse) */ {
 public:
