...
class FrameworkRequestHeader final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.rpc.FrameworkRequestHeader) */ {
 public:
  ...
  inline FrameworkRequestHeader* New() const final {
    return CreateMaybeMessage<FrameworkRequestHeader>(nullptr);
  }
...
class FrameworkResponseHeader final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.rpc.FrameworkResponseHeader) */ {
 public:
  ...
  inline FrameworkResponseHeader* New() const final {
    return CreateMaybeMessage<FrameworkResponseHeader>(nullptr);
  }
