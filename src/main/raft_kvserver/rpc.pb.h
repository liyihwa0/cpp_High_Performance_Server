...
class GetRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.raft_kvserver.GetRequest) */ {
 public:
  GetRequest();
  virtual ~GetRequest();
...
class GetResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.raft_kvserver.GetResponse) */ {
 public:
  GetResponse();
  virtual ~GetResponse();
...
class SetRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.raft_kvserver.SetRequest) */ {
 public:
  SetRequest();
  virtual ~SetRequest();
...
class SetResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:wa.raft_kvserver.SetResponse) */ {
 public:
  SetResponse();
  virtual ~SetResponse();
